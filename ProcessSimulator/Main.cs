...
await FeedbackWriter.WriteFeedbackToJsonAsync(controller.Feedbacks.OfType<ProductionFeedback>().ToList(), "feedbacks.json");
await FeedbackWriter.WriteFeedbackToCSVAsync(controller.Feedbacks.OfType<ProductionFeedback>().ToList(), "feedbacks.csv");
